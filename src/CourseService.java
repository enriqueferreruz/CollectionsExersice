...
public class CourseService
{
    ...
    public void enrollStudent(String studentId, String courseId){
        //implement so it adds the given course form the student
    ...
    public void displayStudentInformation(String studentId){
        // implement so it shows the student name, id and list of enrolled courses
       Student student = students.get(studentId);
       System.out.println(student.toString());
    }
   
//    public int totalCredits(Course credits) {
//    	//implemetn so it calculates the total credits that a student has.
//    	 int total = 0;
//
